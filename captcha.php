...
class SimpleCaptcha
{
     ...
     */
    public $fonts = [
        'IranSANS' => ['minSize' => 18, 'maxSize' => 22, 'font' => 'IranSANS.ttf'],
        'Roya'     => ['minSize' => 20, 'maxSize' => 25, 'font' => 'Roya.ttf'],
        'Tahrir'   => ['minSize' => 20, 'maxSize' => 25, 'font' => 'Tahrir.ttf'],
    ];
    ...
    {
        $rc = new RandomColor();
        $colors = $rc::many($count, ['format'=>'rgb', 'luminosity'=>'dark']);
